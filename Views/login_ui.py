...
class Ui_Login(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.password_check_box=QtWidgets.QCheckBox(parent=self.centralwidget,text="Show Password")
        self.password_check_box.setGeometry(QtCore.QRect(590, 300, 361, 31))
        self.password_check_box.stateChanged.connect(self.change_view_of_password)
