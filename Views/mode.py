...
class SetSetyling:
    ...
    def fix_checkbox(self):
        self.ui.obj.toggled.connect(
            lambda: self.ui.nochoice_chb.setStyleSheet(f"background-color:#3D3C3A;"))
        self.ui.obj.toggled.connect(
            lambda: self.ui.day_le.setStyleSheet(f"background-color:#202020;"))
        self.ui.obj.toggled.connect(
            lambda: self.ui.year_le.setStyleSheet(f"background-color:#202020;"))
        self.ui.obj.toggled.connect(
            lambda: self.ui.month_le.setStyleSheet(f"background-color:#202020;"))
